...
public class TextDocumentFactory implements DocumentFactory {
    ...
    private final IndexingConfiguration config;    private static final Set<String> SUPPORTED_TEXT_EXTENSIONS = Set.of(
    ...
    private String sanitizeContent(String content) {
        ...
        String sanitized = content
            ...
            // Replace multiple consecutive whitespace with single space (but preserve newlines)
            .replaceAll("[ \t]+", " ")
